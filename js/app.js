...
function renderSeasonLeaders() {
  ...
  function leaderCard(stat,valFn,fmtFn,qualifier) {
    ...
    return '<div class="card"'+clickAttr+' style="flex:1;flex-basis:calc(50% - 0.25rem);text-align:center;display:flex;flex-direction:column;align-items:center;min-width:0">'+
